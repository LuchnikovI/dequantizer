...
Scripts:
    convergance_comparison: a script that runs annealers convergence comparison (see root of qmcmc example)
...
case $1 in
  ...
  convergence_comparison)
        shift
        ${docker_run} "${script_dir}/../convergence_comparison.py" $@
    ;;
  *)
